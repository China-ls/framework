...
app.controller('DeviceDetailCtrl', ['$scope', '$stateParams', '$state', '$http', 'NETCONST', '$log',
    function ($scope, $stateParams, $state, $http, NETCONST, $log) {
        ...
        $http.get(NETCONST.CTX + NETCONST.SENSOR_DATA_TODAY.replace("{id}", $stateParams.id))
        ...
        $http.get(NETCONST.CTX + NETCONST.SENSOR_DATA_TOTAL_MONTH.replace("{id}", $stateParams.id))
            .then(function (response) {
                try {
        ...
        $http.get(NETCONST.CTX + NETCONST.SENSOR_DATA_IMAGE_LIST.replace("{id}", $stateParams.id))
            .then(function (response) {
