                ...
                $stateProvider
                    ...
                    .state('app.device', {
                        ...
                        resolve: {
                            deps: ['uiLoad',
                                function (uiLoad) {
                                    return uiLoad.load([
                                        'js/app/map/baidu/load-baidu-maps.js',
                                        'js/app/map/baidu/ui-baidu-map.js',
                                        'js/controllers/dashbord.js']).then(
                                        function () {
                    ...
                    .state('app.device.detail', {
                        ...
                        resolve: {
                            deps: ['$ocLazyLoad',
                                function ($ocLazyLoad) {
                                    return $ocLazyLoad.load(['js/controllers/device-detail.js']);
                                }]
                        }
                    })
