...
@Entity(value = EntityConst.CollectionName.CENCUS_COMPONENT_DAY_HIGH_WATER_LEVEL_COUNT, noClassnameStored = true)
public class SensorDayHighWaterLevelCountCencus extends DayCencusEntity {
