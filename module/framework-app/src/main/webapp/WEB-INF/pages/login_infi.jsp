...
<div class="login" id="login">
    ...
    <div class="login-header">
        <img class="login-title" src="${ctx}/img/logo.png" width="64" height="69" style="margin-top: 5px;padding-top: 5px;">
        <img class="login-title" src="${ctx}/img/title.png" width="256" height="64" style="margin-top: 5px;margin-left: 0;">
    </div>
